...
const EditShippingAddress = ({ id }) => {
  ...
  const editingAddresses = useSelector((state) => state.user.shippingAddress)
  useEffect(() => {
    const address = editingAddresses.find((address) => address._id === id)
    if (address) {
              ...
              <div className='overflow-auto w-[100%] '>
                ...
                <div className='flex flex-col gap-2 w-[80%] overflow-auto'>
                  ...
                  <input
                    ...
                    value={values.name || shippingaddress.name}
                ...
                <div className='flex flex-col gap-2 w-[80%] '>
                  ...
                  <input
                    ...
                    value={values.address || shippingaddress.address}
                    onChange={handleChange}
                    onBlur={handleBlur}
                  />
                  {errors.address && touched.address && (
                ...
                <div className='flex w-[80%]'>
                  <div className='flex flex-col gap-2 w-[100%] '>
                    ...
                    <input
                      ...
                      value={values.city || shippingaddress.city}
                      onChange={handleChange}
                      onBlur={handleBlur}
                    />
                    {errors.city && touched.city && (
                  ...
                  <div className='flex flex-col gap-2 w-[100%] '>
                    ...
                    <input
                      ...
                      value={values.pincode || shippingaddress.pincode}
                      onChange={handleChange}
                      onBlur={handleBlur}
                    />
                    {errors.pincode && touched.pincode && (
                ...
                <div className='flex w-[80%]'>
                  <div className='flex flex-col gap-2 w-[100%] '>
                    ...
                    <input
                      ...
                      value={values.phone1 || shippingaddress.phone1}
                      onChange={handleChange}
                      onBlur={handleBlur}
                    />
                    {errors.phone1 && touched.phone1 && (
                  ...
                  <div className='flex flex-col gap-2 w-[100%] '>
                    ...
                    <input
                      ...
                      value={values.phone2 || shippingaddress.phone2}
                      onChange={handleChange}
                      onBlur={handleBlur}
                    />
                    {errors.phone2 && touched.phone2 && (
                ...
                <div className='flex flex-col gap-2 w-[80%] '>
                  ...
                  <input
                    ...
                    value={values.street || shippingaddress.street}
                    onChange={handleChange}
                    onBlur={handleBlur}
                  />
                  {errors.street && touched.street && (
                ...
                <div className='flex flex-col gap-2 w-[80%] '>
                  ...
                  <input
                    ...
                    value={values.landmark || shippingaddress.landmark}
                    onChange={handleChange}
                    onBlur={handleBlur}
                  />
                  {errors.landmark && touched.landmark && (
